...
- Helper script (recommended):
  - Windows: `python tools/flash_release.py --port COM7 --bin lrs-firmware-0.10.3-za.bin`
  - macOS: `python3 tools/flash_release.py --port /dev/cu.usbserial-XXXX --bin lrs-firmware-0.10.3-za.bin`
...
- Flash at address `0x00000`:
  - Windows: `py -m esptool --port COM7 --baud 460800 write-flash 0x00000 lrs-firmware-0.10.3-za.bin`
  - macOS: `python3 -m esptool --port /dev/cu.usbserial-XXXX --baud 460800 write-flash 0x00000 lrs-firmware-0.10.3-za.bin`
