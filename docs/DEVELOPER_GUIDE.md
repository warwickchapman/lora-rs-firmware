...
- Password-gated commands: `get_config`, `set_config`, `factory_reset`, `configure_gateway`, `set_gateway_targets`, `start_discovery`, `provision_all`, `cancel_provisioning`, `wifi_scan`, `configure_wifi`, `provision_fleet_wifi`, `identify`, `remote_identify`, `remote_identify_status`, `reboot`, `ota_pull`, `remote_ota_pull`, `remote_ota_status`, `remote_factory_reset`, `remote_factory_reset_status`, `start_lora_inventory`, `lora_inventory_status`, and `cancel_lora_inventory`.
