...
- Windows:
  - `python tools/flash_release.py --port COM7 --bin firmware-lrs_za-v0.4.2-alpha.bin`
- macOS:
  - `python3 tools/flash_release.py --port /dev/cu.usbserial-XXXX --bin firmware-lrs_za-v0.4.2-alpha.bin`
