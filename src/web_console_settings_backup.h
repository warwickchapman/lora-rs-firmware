...
inline void captureSettingsBackup(const Settings &src, SettingsBackup &dst) {
  ...
  dst.wifi_phy_mode = src.wifi_phy_mode;
  ...
  dst.wifi_static_ip = src.wifi_static_ip;
  dst.wifi_static_gateway = src.wifi_static_gateway;
  dst.wifi_static_subnet = src.wifi_static_subnet;
  dst.wifi_channel_override = src.wifi_channel_override;
  dst.wifi_ap_fallback_policy = src.wifi_ap_fallback_policy;
